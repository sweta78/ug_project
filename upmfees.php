...
<center><h1>Update Status Of Payment Of Mess Fees</h1>
<br />
...
$seatno=$_POST['seatno'];
 ...
 $retval=mysql_query("update mess set STATUS='PAID' where ROOMNO=\"$roomno\" and SEATNO=\"$seatno\" and NAME=\"$name\" ") or die("could not retrieve");
 
 
 
 $retvalt=mysql_query("select * from mess where ROOMNO=\"$roomno\" and SEATNO=\"$seatno\" and NAME=\"$name\" ") or die("could not retrieve");
 ...
 {
	 echo("<p><p><center><h1>STUDENT DATA DOES NOT EXIST</h1></center></p></p>");
