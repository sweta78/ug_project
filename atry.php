...
$db=mysql_select_db(dbname,$conn) or die("cannot connect database".mysql_error());
 ...
 $retval=mysql_query("select * from hseats ") or die("could not retrieve");
 $row=mysql_numrows($retval);
 
 $ctblm="insert into stu_math select UET_ROLL_NO,NAME,UET_INDEX,CATEGORY from pd where COURSE='B.Sc(Maths)' and PH='NO' order by UET_INDEX desc ";
 $ctblm1=mysql_query($ctblm,$conn);
 $ctblb=mysql_query("insert into stu_bio select UET_ROLL_NO,NAME,UET_INDEX,CATEGORY from pd where COURSE='B.Sc(Bio)' and PH='NO' order by UET_INDEX desc ");
 $ctbla=mysql_query("insert into stu_arts select UET_ROLL_NO,NAME,UET_INDEX,CATEGORY from pd where COURSE='B.A(Arts)' and PH='NO' order by UET_INDEX desc ");
 $ctbls=mysql_query("insert into stu_social select UET_ROLL_NO,NAME,UET_INDEX,CATEGORY from pd where COURSE='B.A(Soc.)' and PH='NO' order by UET_INDEX desc ");
 $ctblph=mysql_query("insert into stu_ph select UET_ROLL_NO,NAME,UET_INDEX,CATEGORY from pd where PH='YES' order by UET_INDEX desc ");
	...
	if($status=='VACANT')
	  {
		 ...
		 if(($category=='GEN')||($category=='OBC'))
		 {
			 if($gen_bio>0)
			 {
		  $up3="update hseats set GEN_BIO= $gen_bio - 1";
		  $try3=mysql_query($up3,$conn);
	  ...
	  //} 
               ...
               if($category=='SC')
		 {
			  if($sc_bio>0)
			  {
		  $up3="update hseats set SC_BIO= $sc_bio - 1";
		  $try3=mysql_query($up3,$conn);
              ...
              if($category=='ST')
		 {
			  if($st_bio>0)
			  {
		  $up3="update hseats set ST_BIO= $st_bio - 1";
		  $try3=mysql_query($up3,$conn);
	...
	if($status=='VACANT')
	  {
		 ...
		 if(($category=='GEN')||($category=='OBC'))
		 {
			 if($gen_math>0)
			 {
		  $up3="update hseats set GEN_MATH= $gen_math - 1";
		  $try3=mysql_query($up3,$conn);
	  ...
	  //} 
               ...
               if($category=='SC')
		 {
			  if($sc_math>0)
			  {
		  $up3="update hseats set SC_MATH= $sc_math - 1";
		  $try3=mysql_query($up3,$conn);
              ...
              if($category=='ST')
		 {
			  if($st_math>0)
			  {
		  $up3="update hseats set ST_MATH= $st_math - 1";
		  $try3=mysql_query($up3,$conn);
	...
	if($status=='VACANT')
	  {
		 ...
		 if(($category=='GEN')||($category=='OBC'))
		 {
			 if($gen_arts>0)
			 {
		  $up3="update hseats set GEN_ARTS= $gen_arts - 1";
		  $try3=mysql_query($up3,$conn);
	  ...
	  //} 
               ...
               if($category=='SC')
		 {
			  if($sc_arts>0)
			  {
		  $up3="update hseats set SC_ARTS= $sc_arts - 1";
		  $try3=mysql_query($up3,$conn);
              ...
              if($category=='ST')
		 {
			  if($st_arts>0)
			  {
		  $up3="update hseats set ST_ARTS= $st_arts - 1";
		  $try3=mysql_query($up3,$conn);
	...
	if($status=='VACANT')
	  {
		 ...
		 if(($category=='GEN')||($category=='OBC'))
		 {
			 if($gen_social>0)
			 {
		  $up3="update hseats set GEN_SOCIAL= $gen_social - 1";
		  $try3=mysql_query($up3,$conn);
	  ...
	  //} 
               ...
               if($category=='SC')
		 {
			  if($sc_social>0)
			  {
		  $up3="update hseats set SC_SOCIAL= $sc_social - 1";
		  $try3=mysql_query($up3,$conn);
              ...
              if($category=='ST')
		 {
			  if($st_arts>0)
			  {
		  $up3="update hseats set ST_SOCIAL= $st_social - 1";
		  $try3=mysql_query($up3,$conn);
